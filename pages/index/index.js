...
Page({
    ...
    getPageData(page) {
        wx.request({
            url: 'https://www.lanrenzaodu.top/service/page',
    ...
    refresh(){
        wx.request({
            url: 'https://www.lanrenzaodu.top/service/refresh',
...
　　　 var that = this;
    ...
    onLoad: function() {  
        ...
        // 初始化热点数据
        wx.request({
            url: 'https://www.lanrenzaodu.top/service/init',
            header: {'content-type': 'application/json;charset=UTF-8;'},
            method: 'GET',
            success: res => {
                this.setData({
        ...
        // 开启轮询后台接口
        wx.request({
            url: 'https://www.lanrenzaodu.top/service/time',
            header: {'content-type': 'application/json;charset=UTF-8;'},
            method: 'GET',
            success: res => {
                this.setData({
